...
public class DepositActivity extends AppCompatActivity {
    ...
    EditText acNumber, amount, desc,phone,code;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setActionBarTitle("DEPOSIT MONEY");
        ...
        code = findViewById(R.id.transCode);
        phone = findViewById(R.id.phone);

        acNumber.setText(prf.getString("AccountNumber"));
        desc.setText("Account Deposit");
    ...
    public void saveData() {
        ...
        String transcode = code.getEditableText().toString().trim();
         ...
         if (TextUtils.isEmpty(amt)) {
            ...
            cancel = true;
             ...
             focusView = desc;
             cancel = true;
         }else if(TextUtils.isEmpty(transcode)){
             code.setError("Transaction Code cannot be empty!");
             focusView = code;
             cancel = true;
         }
         else {
            depositMoney(prf.getString("ID"),amt,descrp,network,fone,transcode);
        }
    ...
    private void depositMoney(String id, String amt, String dec,String network,String fone,String code) {
        final String url = Config.API_URL + "Apis.php?func=customerDeposit";
  ...
  /*  private void depositMoney(String id, String amt, String dec,String network,String fone,String code) {
        final String url = Config.API_URL + "deposit.php?id="+id+"&amt="+amt+"&desc="+dec+"&code="+code+"&phone="+fone+"&type="+network;
        // Showing progress dialog at user registration time.
        progressDialog.setMessage("Processing Transaction,  Please Wait!!!");
        progressDialog.show();

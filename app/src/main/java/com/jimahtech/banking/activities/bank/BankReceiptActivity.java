...
public class BankReceiptActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setActionBarTitle("BANK DAILY RECEIPTS");
        ...
        prf = new PrefManager(BankReceiptActivity.this);
            ...
            public void onResponse(JSONObject response) {
                try {
                    if (response.length() > 0) {
                        ...
                        linearLayoutManager = new LinearLayoutManager(BankReceiptActivity.this);
                        recyclerView.setHasFixedSize(true);
                        recyclerView.setItemAnimator(new DefaultItemAnimator());
                        recyclerView.setLayoutManager(linearLayoutManager);
                        adapter = new ReceiptAdapter(BankReceiptActivity.this, arrayList);
